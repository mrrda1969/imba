...
mixin _$ImageModel {
 ...
 String get url; String get listingId; String? get id; DateTime? get createdAt; DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,url,listingId,id,createdAt,updatedAt);

@override
String toString() {
  return 'ImageModel(url: $url, listingId: $listingId, id: $id, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String url, String listingId, String? id, DateTime? createdAt, DateTime? updatedAt
});
...
/// Create a copy of ImageModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? url = null,Object? listingId = null,Object? id = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String url,  String listingId,  String? id,  DateTime? createdAt,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ImageModel() when $default != null:
return $default(_that.url,_that.listingId,_that.id,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String url,  String listingId,  String? id,  DateTime? createdAt,  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _ImageModel():
return $default(_that.url,_that.listingId,_that.id,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String url,  String listingId,  String? id,  DateTime? createdAt,  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _ImageModel() when $default != null:
return $default(_that.url,_that.listingId,_that.id,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _ImageModel implements ImageModel {
  const _ImageModel({required this.url, required this.listingId, this.id, this.createdAt, this.updatedAt});
...
/// Create a copy of ImageModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? url = null,Object? listingId = null,Object? id = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
